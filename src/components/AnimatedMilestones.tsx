...
const AnimatedMilestones = () => {
    ...
    return (
        <div
            ref={sectionRef}
            className="bg-gradient-to-br from-pink-100 via-purple-100 via-blue-100 via-cyan-100 to-blue-100 py-5 flex flex-col items-center relative overflow-hidden min-h-screen"
        >
